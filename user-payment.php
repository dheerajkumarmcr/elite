...
<!--Header-part-->
<div id="header">
  <h1><a href="">Perfect Elite Admin</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admindashboard.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="payment.php">Payments</a> <a href="#" class="current">Invoice</a> </div>
    <h1>Payment Form</h1>
  </div>
