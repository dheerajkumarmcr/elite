...
if (isset($_GET['id'])) {
    ...
    // Fetch the popup details based on the provided ID
    $qry = "SELECT * FROM popup WHERE id='$id'";
...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="popup.php" class="tip-bottom">Popup</a>
            <a href="edit-popup.php" class="current">Edit Popup Image</a>
        </div>
        <h1 class="text-center">Update Popup Image <i class="fas fa-briefcase"></i></h1>
    </div>
            ...
            <div class="span6">
                <div class="widget-box">
                    <div class="widget-content nopadding">
                        <form action="edit-popup-req.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
...
<div class="control-group">
    <label class="control-label">Edit Popup Image</label>
    <div class="controls">
        ...
        <span id="file-validation-message" style="color: red;">(You can choose only JPG, JPEG, or PNG images with 300*300 pixels)</span>
            ...
            <div class="form-actions text-center">
             ...
             <input type="hidden" name="id" value="<?php echo $row['id'];?>">
              <button type="submit" class="btn btn-success">Update Popup Image</button>
              <div id="status"></div>
            </div>
