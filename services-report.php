...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Perfect Elite Admin</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admindashboard.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="services-report.php" class="current">Chart Representation</a> </div>
    <h1 class="text-center">Elite Services Report <i class="fas fa-bar-chart"></i></h1>
  </div>
